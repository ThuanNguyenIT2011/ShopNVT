...
import com.shopme.admin.user.UserNotException;
...
public class UserController {
	...
	public String editEnabled(@PathVariable(name = "id") Integer id, @PathVariable(name = "status") boolean status,

...
@Component
public class DatabaseLoginSuccessSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
	...
	public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
		...
		customerService.updateAutheticationType(customer, TypeRegister.DATABASE);
